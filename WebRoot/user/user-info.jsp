								...
								<ul class="nav nav-sidebar">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li><a href="${pageContext.request.contextPath }/user_view.action"><span class="text"> 个人信息</span></a></li>
											<li><a href="${pageContext.request.contextPath }/user_list.action"><span class="text">用户查询</span></a></li>
											<li><a href="${pageContext.request.contextPath }/user/user-login.jsp"><span class="text"> 用户登录</span></a></li>
											<li><a href="${pageContext.request.contextPath }/user/user-regist.jsp"><span class="text"> 用户注册</span></a></li>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bk-vcenter text-center">                                
												<div class="bk-avatar">
													...
													</s:else>" height="200" alt="头像预览" class="img-circle bk-img-120 bk-border-light-gray bk-border-3x"><br><br>
