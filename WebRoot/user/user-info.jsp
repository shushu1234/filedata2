                ...
                <div class="sidebar-menu">
                    <nav id="menu" class="nav-main" role="navigation">
                        <ul class="nav nav-sidebar">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/message/message-inbox.jsp">
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="${pageContext.request.contextPath }/user_view.action"><span
                                            class="text"> 个人信息</span></a></li>
                                    <li><a href="${pageContext.request.contextPath }/user_list.action"><span
                                            class="text">用户查询</span></a></li>
                                    <li><a href="${pageContext.request.contextPath }/user/user-login.jsp"><span
                                            class="text"> 用户登录</span></a></li>
                                    <li><a href="${pageContext.request.contextPath }/user/user-regist.jsp"><span
                                            class="text"> 用户注册</span></a></li>
                            ...
                            <li class="nav-parent">
                                <a>
                                    <i class="fa fa-tasks" aria-hidden="true"></i><span>文件管理</span>
                                </a>
                                <ul class="nav nav-children">
                                    <li><a href="${pageContext.request.contextPath }/file/file-upload.jsp"><span
                                            class="text">文件上传</span></a></li>
                                    <li><a href="${pageContext.request.contextPath }/file_list.action"><span
                                            class="text">文件查询</span></a></li>
                                    <li>
                                        <a href="${pageContext.request.contextPath }/file/file-detail.jsp">文件详情</span></a>
                                    </li>
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="${pageContext.request.contextPath }/kind_list.action">类别列表</span></a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath }/kind/kind-add.jsp"><span
