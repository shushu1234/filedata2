					...
					<div class="row box-error">					
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="text-center">
								<h1>恭喜你 :)</h1>
								<h2>你的邮箱为:<span style="color: red;font-size: 40px"><s:property value="email"/> </span></h2>
								<h3>重置邮件发送成功</h3>
								<input type="hidden" value="<s:property value="email"/>" id="useremail">
								<h4>如果长时间未接收到重置邮件，有可能被放进垃圾箱了，请尝试恢复，谢谢你的参与...</h4>
								<a href="${pageContext.request.contextPath}/user/user-login.jsp">
									<button type="button" class="btn btn-primary"><i class="fa fa-user"></i> 登录</button>
								</a>
								<a id="go" href="#">
									<button type="button" class="btn btn-primary"><i class="fa fa-envelope-o"></i> 重置</button>
								</a>
							</div>
						</div>					
					</div>			
