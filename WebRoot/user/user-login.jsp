...
<%-- 									<form class="form-horizontal login" action="${pageContext.request.contextPath}/user_login.action" method="post"> --%>
									<s:form action="user_login" namespace="/" method="post" cssClass="form-horizontal login" theme="simple">
										...
										<div class="bk-padding-left-20 bk-padding-right-20">
											<div class="form-group">
												...
												<div class="input-group input-group-icon">
													...
													<s:textfield name="id" cssClass="form-control bk-radius" placeholder="请输入学号或工号"></s:textfield>
												...
												<s:fielderror fieldName="id" cssStyle="margin-top:5px;color: #ff0714;list-style: none;"></s:fielderror>
											</div>
											<div class="form-group">
												<label> 密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码 </label>
												<div class="input-group input-group-icon">
					<!-- 								<input type="password" class="form-control bk-radius" name="pwd" placeholder="请输入密码"/> -->
													<s:password name="pwd" cssClass="form-control bk-radius" placeholder="请输入密码"></s:password>
													<span class="input-group-addon">
														<span class="icon">
															<i class="fa fa-key"></i>
														</span>
												...
												<s:fielderror fieldName="pwd" cssStyle="margin-top:5px;color: #ff0714;list-style: none;"></s:fielderror>
											</div>
											...
											<p class="text-center">还没有账户？<a href="${pageContext.request.contextPath}/user/user-regist.jsp">去注册!</a></p>
										</div>
										</s:form>
									<!-- </form> -->
								</div>
