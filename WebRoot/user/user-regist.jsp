						...
						<div class="register-box">
							<div class="panel">
								<div class="panel-body">										
									...
									<s:form cssClass="form-horizontal register" action="user_regist" method="post" namespace="/" theme="simple" enctype="multipart/form-data">
...
<!-- 												<input name="id" type="text" class="form-control" placeholder="请输入学/工号" id="id"/>
 -->												<s:textfield name="id" cssClass="form-control" id="id" placeholder="请输入学/工号"> </s:textfield>
...
<!-- 												<input name="name" type="text" class="form-control" placeholder="请输入姓名" id="name"/>
 -->												<s:textfield name="name" cssClass="form-control" placeholder="请输入姓名" id="name"></s:textfield>
...
<!-- 												<input name="tel" type="tel" class="form-control" placeholder="请输入电话号码" id="tel"/>
 -->												<s:textfield name="tel" cssClass="form-control"  placeholder="请输入电话号码" id="tel"></s:textfield>
...
<!-- 												<input name="email" type="email" class="form-control" placeholder="请输入邮箱" id="email"/>
 -->												<s:textfield name="email" cssClass="form-control" placeholder="请输入邮箱" id="email"></s:textfield>
...
<!-- 														<input name="pwd" type="password" class="form-control bk-margin-bottom-10" placeholder="请输入密码" id="pwd"/>
 -->														<s:password name="pwd" cssClass="form-control bk-margin-bottom-10" placeholder="请输入密码" id="pwd"></s:password>
													</div>
													<div class="col-sm-6">
														<label>确认密码</label>
														<input name="pwdConfirm" type="password" class="form-control bk-margin-bottom-10" placeholder="请确认密码" id="pwdConfirm"/>
													</div>
												</div>
											...
											<p class="text-center">已经有账号? <a href="${pageContext.request.contextPath}/user/user-login.jsp">去登录!</a>
										</div>	
										</s:form>
