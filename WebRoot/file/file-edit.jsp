...
<s:fielderror></s:fielderror>
									<s:form cssClass="form-horizontal" action="file_edit" namespace="/" theme="simple" method="post"  novalidate="novalidate" enctype="multipart/form-data" name="editform">
										...
										<div class="tab-content">
											<div id="w4-account" class="tab-pane active">
												<div class="form-group">
													...
													<!-- 	<input type="file" id="file-input" name="file-input" required> -->
														<s:textfield name="name" cssClass="form-control" id="filename" readonly="true" value="%{model.name}"  > </s:textfield>
													</div>
												</div>
											</div>
											<div id="w4-profile" class="tab-pane">
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<s:textfield cssClass="form-control required" name="authorname1" id="w4-first-name" value="%{model.authorname1}" ></s:textfield>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<s:textfield cssClass="form-control" name="authorname2" id="w4-last-name" value="%{model.authorname2}"></s:textfield>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<!-- <input type="text" class="form-control" name="last-name" id="w4-last-name" > -->
														<s:textfield cssClass="form-control" name="authorname3" id="w4-last-name" value="%{model.authorname3}"></s:textfield>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<!-- <input type="text" class="form-control" name="last-name" id="w4-last-name" > -->
														<s:textfield cssClass="form-control" name="authorname4" id="w4-last-name" value="%{model.authorname4}"></s:textfield>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<!-- <input type="text" class="form-control" name="last-name" id="w4-last-name" > -->
														<s:textfield cssClass="form-control" name="authorname5" id="w4-last-name" value="%{model.authorname5}"></s:textfield>
													</div>
												</div>
											</div>
											<div id="w4-billing" class="tab-pane">
												<div class="form-group">
													...
													<div class="col-md-9">
														<s:select list="#{'1':'资料','2':'图片','3':'视频','4':'音乐'}" cssClass="form-control required" id="select" name="kindid" size="1" headerKey="" headerValue="--选择分类--" value="%{model.kindid}"></s:select>
													</div>
												</div>
											</div>
											<div id="w4-confirm" class="tab-pane">
												<div class="form-group">
													...
													<div class="col-md-9">
														<s:textarea id="textarea-input" name="remark" rows="9" cssClass="form-control" placeholder="请输入文件的备注信息，有助于管理员的审核..."  value="%{model.remark}"></s:textarea>
													</div>
												</div>
