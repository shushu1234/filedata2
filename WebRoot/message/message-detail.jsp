...
<html lang="en">
	...
	<head>
		...
		<title>Messages | Fire - Admin Template</title>
							...
							<div class="panel">
								<div class="panel-heading bk-bg-white mailbox-btn-action bk-padding-top-20 bk-padding-bottom-20">
									...
									<span class="item-action-group text-left">
										<a class="item-action fa fa-mail-reply" href="${pageContext.request.contextPath}/message/message-compose.jsp?id=${model.sender}"></a>
